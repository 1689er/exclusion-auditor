...
Usage:
    python -m exclusion_auditor.precheck --config config.yaml
"""
...
from .adapters.crowdstrike import CLOUD_URLS, CrowdStrikeAdapter, VALID_TYPES
...
def run(config_path: str) -> int:
    ...
    types = [t for t in cfg.adapter_opts.get("exclusion_types", list(VALID_TYPES)) if t in _TYPE_LABEL]
